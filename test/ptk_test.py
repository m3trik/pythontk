...
class Core_test(Main):
	...
	def test_imports(self):
		...
		'''
		self.perform_test({
			"str(self.makeList).rsplit(' ', 1)[0]": '<function Iter.makeList at',
			"str(self.makeList).rsplit(' ', 1)[0]": '<function Iter.makeList at',
